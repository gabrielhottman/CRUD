...
void pasarDeInterfazAReglasDeNegocio()
 {
...
void pasarDeReglasdeNegocioAinterfaz()
{
   //txtNombre.setText(usuario.getUsuario().getNombre() ); 
   //txtNombre.setText(Conexionbd.getInstancia().resultado.getString("Nombre")); 
...
//   txtId.setText(Integer.toString(usuario.getUsuario().getId())); 
   txtId.setText(Integer.toString(GestionUsuario.Id));
   txtNombre.setText(GestionUsuario.Nombre ); 
   txtApe.setText(GestionUsuario.Apellido ); 
   txtCed.setText(Integer.toString(GestionUsuario.Cedula) ); 
    ...
    private void btnInserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserActionPerformed
        ...
        try {
         pasarDeInterfazAReglasDeNegocio();
         usuario.Insertar();
    ...
    private void btnModiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModiActionPerformed
        ...
        try {
         pasarDeInterfazAReglasDeNegocio();  
         usuario.Modificar();
         JOptionPane.showMessageDialog(this, "Dato modificado correctamente");
        }
        catch (SQLException ex)
        {
            JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    private void btnConsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsulActionPerformed
       try {
        usuario.getUsuario().setId(Integer.parseInt(txtId.getText()));
        usuario.Consultar();
        pasarDeReglasdeNegocioAinterfaz();  
        JOptionPane.showMessageDialog(this, "Consulta hecha correctamente");
